...
especially when representing permissioned assets such as digital securities. 
This often takes form on-chain as user "_transferlists_", i.e. lists of which 
users may be the sender/receiver of a transfer.
