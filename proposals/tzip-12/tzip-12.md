...
A particular permission policy defines the semantics (logic thats defines if a
...
implement core behavior extension). If additional permission hook fails, the whole
