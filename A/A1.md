...
- [ADT syntax sugar](#adt-syntax-sugar)
- [CASE macro](#case-macro)
- [View Entry-points](#view-entry-points)
- [Void Entry-points](#void-entry-points)
...
tree stands for an argument of some entry point. Leaves are annotated with
...
This marco definition works when entrypoints form a right-hand comb
...
There is a [multiple entrypoints](https://gitlab.com/nomadic-labs/tezos/merge_requests/59)
proposal which hopefully allow for this issue resolution.
